...
\newcommand{\figActivityDiagram}{%
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{Figures/diagrams/activitydiagram.png}
...
\newcommand{\figProfileScreen}{%
    \centering
    \includegraphics[width=0.95\linewidth,height=0.22\textheight,keepaspectratio]{Figures/pages/profile.png}
    \captionof{figure}{Профайл дэлгэц – статистик, streak, ахиц дэвшлийн мэдээлэл.}
    \label{fig:profile}
}

\newcommand{\figNotificationScreen}{%
    \centering
    \includegraphics[width=0.95\linewidth,height=0.22\textheight,keepaspectratio]{Figures/pages/notification.png}
    \captionof{figure}{Мэдэгдлийн дэлгэц – сануулга, streak болон амжилтын мэдэгдлүүд.}
    \label{fig:notifications}
}

\newcommand{\figSettingsScreen}{%
    \centering
    \includegraphics[width=0.95\linewidth,height=0.22\textheight,keepaspectratio]{Figures/pages/settings.png}
    \captionof{figure}{Тохиргооны дэлгэц – хэл сонголт, theme, мэдэгдэл ба зорилтын тохиргоо.}
    \label{fig:settings}
}

\newcommand{\figSecurityPrivacyScreen}{%
    \centering
    \includegraphics[width=0.95\linewidth,height=0.22\textheight,keepaspectratio]{Figures/pages/security_privacy.png}
    \captionof{figure}{Аюулгүй байдал ба нууцлалын тохиргооны дэлгэц.}
...
\newcommand{\figOCRLearningCurve}{%
  \begin{figure}[H]
    ...
    \caption{TensorFlow.js OCR моделийн сургалтын явцын муруйн график (алдагдал болон үнэн зөвийн хувь).}
...
\newcommand{\figTrainingEpochs}{%
  \begin{figure}[H]
    ...
    \caption{OCR моделийн сургалтын epoch бүрийн алдагдал, үнэн зөвийн өөрчлөлтийн график.}
    \label{fig:epochs}
  \end{figure}
}
...
\newcommand{\figModelSegmentation}{%
  \begin{figure}[H]
    ...
    \caption{OCR моделийн тэмдэгт тусгаарлах (segmentation) жишээ зургийн цуглуулга.}
