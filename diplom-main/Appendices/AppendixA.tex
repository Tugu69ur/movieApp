...
\hline
016 & \ifdefined\XeTeXversion\input{Appendices/mongolian_phrase}\else\ifdefined\directlua\input{Appendices/mongolian_phrase}\else [Traditional Mongolian phrase; render with XeLaTeX/LuaLaTeX]\fi\fi & phrase & phrase sample & examples \\
\hline
\end{tabular}
\end{table}
