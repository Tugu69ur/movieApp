...
\begin{lstlisting}[language=JavaScript, caption=Flashcards Collection Structure]
flashcards/
  {flashcardId}/
...
\begin{lstlisting}[language=JavaScript, caption=Users Collection Structure]
users/{userId}/
...
\begin{lstlisting}[language=JavaScript, caption=UserProgress Collection Structure]
...
\begin{lstlisting}[language=JavaScript, caption=Favorites and DailyWords]
favorites/{userId}/
...
\subsection*{А.9 Төслийн статистик}
...
\subsection*{А.11 Төслийн GitHub repository}

Төслийн эх код нь дараах хаягаар нээлттэй эхтэй байршуулагдсан:

\texttt{https://github.com/Tugu69ur/movieApp}
